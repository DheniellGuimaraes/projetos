...
final class RMA_Admin_Settings {
    ...
    public function inject_admin_brand_styles(): void {
        ...
        $targets = ['rma-admin-settings', 'rma-newsletter-list', 'rma-relatorios', 'rma-emails-assinatura'];
