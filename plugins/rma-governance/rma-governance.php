        ...
        (function(){
            ...
            function cleanupLegacyShell(){
                ...
                document.querySelectorAll('.content-wrapper .row').forEach(function(row){
                    ...
                    if (txt.indexOf('welcome back employer') !== -1 || txt.indexOf('profile views') !== -1 || txt.indexOf('recent proposals') !== -1 || txt.indexOf('most viewed projects') !== -1 || txt.indexOf('current plan detail') !== -1) {
                        row.remove();
                    }
                });
            }
