...
final class RMA_Governance {
    ...
    private function render_entity_finance_support_bridge(string $ext): string {
        ...
        if ($ext === 'rma-financeiro-visao-geral') {
            ...
            $html .= '<p style="margin:0 0 8px"><label>Categoria<br/><select name="rma_support_priority" required style="width:100%"><option value="problema_tecnico">1 - Problema técnico</option><option value="duvida_institucional">2 - Dúvida institucional</option><option value="financeiro">3 - Financeiro</option><option value="outros">4 - Outros</option></select></label></p>';
