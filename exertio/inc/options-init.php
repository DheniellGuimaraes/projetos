	...
	function rma_map_showcase_shortcode($atts = array())
	{
		...
		<div class="rma-map-showcase-shortcode">
			<style>
				...
				.rma-map-showcase-shortcode .rma-map-directory{padding:14px;border-radius:18px;}
				...
				.rma-map-showcase-shortcode #rma-map-pins .rma-map-pin{transform:translate(-50%,-100%) scale(.9);}
			</style>
