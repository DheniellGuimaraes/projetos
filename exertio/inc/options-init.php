	...
	function rma_map_fetch_entities($request_params = array())
	{
		...
		if (!empty($entity_query->posts)) {
			foreach ($entity_query->posts as $employer_id) {
				$lat = rma_map_meta_value($employer_id, array('_employer_latitude', '_latitude'));
				$lng = rma_map_meta_value($employer_id, array('_employer_longitude', '_longitude'));
				...
				$entity_state = strtolower((string) rma_map_meta_value($employer_id, array('_employer_state', '_state')));
				$entity_city = (string) rma_map_meta_value($employer_id, array('_employer_city', '_city'));
