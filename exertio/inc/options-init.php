	...
	function rma_map_showcase_shortcode($atts = array())
	{
		...
		<div class="rma-map-showcase-shortcode">
			<style>
				...
				.rma-map-showcase-shortcode .rma-map-kpis,
				.rma-map-showcase-shortcode .rma-map-filters,
				.rma-map-showcase-shortcode .rma-map-feedback,
				.rma-map-showcase-shortcode .rma-map-results,
				.rma-map-showcase-shortcode .rma-map-pagination{display:none !important;}
