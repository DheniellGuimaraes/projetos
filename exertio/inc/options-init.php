...
.rma-map-directory[data-map-mode="dashboard_map_ext"] .rma-map-kpis{display:none !important}
			.rma-map-directory[data-map-mode="dashboard_map_ext"] .rma-map-brazil h4{display:none !important}
			.rma-map-directory[data-map-mode="dashboard_map_ext"] .rma-map-results{display:none !important}
			...
			<div class="rma-map-directory" data-endpoint="<?php echo esc_url($endpoint); ?>" data-per-page="<?php echo esc_attr($per_page); ?>" data-search-required="<?php echo esc_attr($search_required); ?>" data-map-mode="<?php echo esc_attr($mode); ?>">
